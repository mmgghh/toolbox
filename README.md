...
| `pyps`     | `toolbox ps`     | Top memory/swap consumers, search and kill by name or port, `free`-like summary (Linux/Termux) | [docs/pyps.md](docs/pyps.md) |
...
| `pyhtml2md` | `toolbox html2md` | HTML to Markdown, no dependencies, raw HTML only when truly needed | [docs/pyhtml2md.md](docs/pyhtml2md.md) |
